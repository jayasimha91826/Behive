        ...
        {cards.map((card, index) => (
          <div className="card" key={index}>
            ...
            <div className="distance">
              <img src={card.distance} alt="card-img"/>
            </div>
              </div>
            ...
            <img className="layering" src={card.tag} alt="layer-img"/>
          </div>
        ))}
      </div>
      {/* <div className="cards">
        {cards2.map((card, index) => (
          <div className="card" key={index}>
            <h3>{card.title}</h3>
            <div className="distance">
            <img className="layering1" src={card.tag} alt="img"/>
              <img src={card.distance} alt="img"/>
            </div>
            <img className="mainImg" src={card.image} alt={card.title} />
            <div className="discount">{card.discount}</div>
            <div className="price">
